export const movies = [
    {
        ...
        sessions: [
            ...
            {id: 4, hour: "17:00", language: Math.random() < 0.5 ? "castellano" : "vose"},
            {id: 5, hour: "18:00", language: Math.random() < 0.5 ? "castellano" : "vose"},
            {id: 6, hour: "20:00", language: Math.random() < 0.5 ? "castellano" : "vose"}
        ]
    },
    {
        id: 2,
        ...
        sessions: [
            ...
            {id: 3, hour: "21:00", language: Math.random() < 0.5 ? "castellano" : "vose"}
        ]
    },
    {
        id: 3,
